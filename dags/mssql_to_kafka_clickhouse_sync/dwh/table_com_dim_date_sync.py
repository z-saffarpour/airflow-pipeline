"""
Airflow DAG: COM.Dim_Date to Kafka (Config-based)
=================================================
This DAG reads dimension date data from SQL Server and transfers it to Kafka.
...
dag_config= DAGConfig(
    dag_id = 'table_dwh_com_dim_date_sync',
    description = 'Sync COM.Dim_Date dimension table from SQL Server to Kafka',
...
kafka_topic_config= KafkaTopicConfig(
    name = 'dwh.table.curated.com.dim_date',
    num_partitions = 3,
