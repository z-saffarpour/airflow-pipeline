"""
Airflow DAG: RTL.DIM_SystemType to Kafka (Config-based)
=================================================
This DAG reads dimension SystemType data from SQL Server and transfers it to Kafka.
...
from pipeline.config import DAGConfig, ConnectionConfig, KafkaTopicConfig, TableConfiguration, SyncConfig, ClickHouseConfig
...
dag_config= DAGConfig(
    dag_id = 'table_dwh_rtl_dim_system_type_sync',
    description = 'Sync RTL.DIM_SystemType dimension table from SQL Server to Kafka',
...
kafka_topic_config= KafkaTopicConfig(
    name = 'dwh.table.curated.rtl.dim_systemtype',
    num_partitions = 3,
