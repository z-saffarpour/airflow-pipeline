"""
Airflow DAG: ax.RetailGroupMemberLine Query to Store
===============================================
This DAG executes a business query on ax.RetailGroupMemberLine and sends results to Store.
...
dag_config = DAGConfig(
    ...
    description = 'masterdata query sync from ax.RetailGroupMemberLine to Store',
...
sync_config =  MasterDataSyncConfig(
    ...
    chunk_column='RECID',
    task_chunk_size=int(Variable.get("task_chunk_size_retail_group_member_line", default_var=100000)),
    max_parallel_chunks=int(Variable.get("max_parallel_chunks_retail_group_member_line", default_var=8)),
    max_global_parallel_chunks=int(Variable.get("max_global_parallel_chunks_replication_md_store", default_var=32)),

    target_schema = 'ax',
    target_table = 'RetailGroupMemberLine',
