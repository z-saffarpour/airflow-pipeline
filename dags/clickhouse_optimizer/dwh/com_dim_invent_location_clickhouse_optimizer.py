"""
Airflow DAG: COM.DIM_InventLocation ClickHouse Optimization Pipeline
==========================================================
This DAG runs OPTIMIZE TABLE on ClickHouse for DIM_InventLocation table after data is 
...
DAG_CONFIG = DAGConfig(
    dag_id='com_dim_invent_location_clickhouse_optimizer',
    description = 'Optimize COM.DIM_InventLocation table in ClickHouse after Kafka data ingestion',
...
OPTIMIZE_CONFIG = ClickHouseOptimizationConfig(
    ...
    database = 'COM',
    table_name = 'Local_DIM_InventLocation',
