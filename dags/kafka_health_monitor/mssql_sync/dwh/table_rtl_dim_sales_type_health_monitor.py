"""
Airflow DAG: RTL.DIM_SalesType Pipeline Health Monitor
======================================================
Monitor RTL.DIM_SalesType Kafka pipeline health.

Related sync DAG(s): table_dwh_rtl_dim_sales_type_sync
Topic: dwh.table.curated.rtl.dim_salestype
...
DAG_CONFIG = DAGConfig(
    dag_id="table_dwh_rtl_dim_sales_type_health_monitor",
    description="Monitor RTL.DIM_SalesType Kafka pipeline health",
...
HEALTH_CONFIG = KafkaHealthMonitorConfig(
    kafka_topic="dwh.table.curated.rtl.dim_salestype",
    consumer_group="clickhouse-consumer.dwh.table.curated.rtl.dim_salestype",
    sample_count=5,
