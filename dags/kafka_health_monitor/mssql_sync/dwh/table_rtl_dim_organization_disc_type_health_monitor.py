"""
Airflow DAG: RTL.DIM_OrganizationDiscType Pipeline Health Monitor
=================================================================
Monitor RTL.DIM_OrganizationDiscType Kafka pipeline health.

Related sync DAG(s): table_dwh_rtl_dim_organization_disc_type_sync
Topic: dwh.table.curated.rtl.dim_organizationdisctype
...
DAG_CONFIG = DAGConfig(
    dag_id="table_dwh_rtl_dim_organization_disc_type_health_monitor",
    description="Monitor RTL.DIM_OrganizationDiscType Kafka pipeline health",
...
HEALTH_CONFIG = KafkaHealthMonitorConfig(
    kafka_topic="dwh.table.curated.rtl.dim_organizationdisctype",
    consumer_group="clickhouse-consumer.dwh.table.curated.rtl.dim_organizationdisctype",
    sample_count=5,
