"""
Airflow DAG: COM.DIM_Date Pipeline Health Monitor
=================================================
Monitor COM.DIM_Date Kafka pipeline health.

Related sync DAG(s): table_dwh_com_dim_date_sync
Topic: dwh.table.curated.com.dim_date
...
DAG_CONFIG = DAGConfig(
    dag_id="table_dwh_com_dim_date_health_monitor",
    description="Monitor COM.DIM_Date Kafka pipeline health",
...
HEALTH_CONFIG = KafkaHealthMonitorConfig(
    ...
    kafka_topic="dwh.table.curated.com.dim_date",
    consumer_group="clickhouse-consumer.dwh.table.curated.com.dim_date",
    sample_count=5,
