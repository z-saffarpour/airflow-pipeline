"""
Airflow DAG: COM.DIM_InventSite Pipeline Health Monitor
=======================================================
Monitor COM.DIM_InventSite Kafka pipeline health.

Related sync DAG(s): table_dwh_com_dim_invent_site_sync
Topic: dwh.table.curated.com.dim_inventsite
...
DAG_CONFIG = DAGConfig(
    dag_id="table_dwh_com_dim_invent_site_health_monitor",
    description="Monitor COM.DIM_InventSite Kafka pipeline health",
...
HEALTH_CONFIG = KafkaHealthMonitorConfig(
    kafka_topic="dwh.table.curated.com.dim_inventsite",
    consumer_group="clickhouse-consumer.dwh.table.curated.com.dim_inventsite",
    sample_count=5,
