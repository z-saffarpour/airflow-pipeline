"""
Airflow DAG: RTL.DIM_CostAmount Pipeline Health Monitor
=======================================================
Monitor RTL.DIM_CostAmount Kafka pipeline health.

Related sync DAG(s): table_dwh_rtl_dim_cost_amount_sync
Topic: dwh.table.curated.rtl.dim_costamount
...
DAG_CONFIG = DAGConfig(
    dag_id="table_dwh_rtl_dim_cost_amount_health_monitor",
    description="Monitor RTL.DIM_CostAmount Kafka pipeline health",
...
HEALTH_CONFIG = KafkaHealthMonitorConfig(
    kafka_topic="dwh.table.curated.rtl.dim_costamount",
    consumer_group="clickhouse-consumer.dwh.table.curated.rtl.dim_costamount",
    sample_count=5,
