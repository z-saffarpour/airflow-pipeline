"""
Airflow DAG: dbo.INVENTSUM Pipeline Health Monitor
==================================================
Monitor dbo.INVENTSUM Kafka pipeline health.

Related sync DAG(s): query_ax_invent_sum_sync / query_ax_invent_sum_full_sync
Topic: ax.query.raw.dbo.inventsum
...
DAG_CONFIG = DAGConfig(
    dag_id="query_ax_invent_sum_health_monitor",
    description="Monitor dbo.INVENTSUM Kafka pipeline health",
...
HEALTH_CONFIG = KafkaHealthMonitorConfig(
    ...
    kafka_topic="ax.query.raw.dbo.inventsum",
    consumer_group="clickhouse-consumer.ax.query.raw.dbo.inventsum",
    sample_count=5,
