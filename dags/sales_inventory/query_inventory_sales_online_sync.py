...
BATCH_SIZE = int(Variable.get("batch_size_inventory_sales_online", default_var = 10000))
...
with DAG(
    dag_id="query_inventory_sales_online_sync",
    description="Daily sync of e-commerce data to Kafka.",
    ...
    with TaskGroup("processing") as processing:                
        process_sales_online = process_sales_online_task(version=version)
