"""
Airflow DAG: COM.DIM_InventSite to Kafka (Config-based)
=================================================
...
dag_config= DAGConfig(
    dag_id = 'table_dwh_com_dim_invent_site_sync',
    description = 'Sync COM.DIM_InventSite dimension table from SQL Server to Kafka',
...
kafka_topic_config= KafkaTopicConfig(
    name = 'dwh.table.curated.com.dim_inventsite',
    num_partitions = 3,
