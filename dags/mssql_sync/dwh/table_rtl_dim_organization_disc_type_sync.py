"""
Airflow DAG: RTL.DIM_SaleIsReturnSale to Kafka (Config-based)
=================================================
This DAG reads dimension OrganizationDiscType data from SQL Server and transfers it to Kafka.
...
dag_config= DAGConfig(
    dag_id = 'table_dwh_rtl_dim_organization_disc_type_sync',
    description = 'Sync RTL.DIM_OrganizationDiscType dimension table from SQL Server to Kafka',
...
table_config = TableConfiguration (
    table_name = 'RTL.DIM_OrganizationDiscType',
    date_column = None,
...
kafka_topic_config= KafkaTopicConfig(
    name = 'dwh.table.curated.rtl.dim_organizationdisctype',
    num_partitions = 3,
