...
=================================================
This DAG reads dimension SaleIsReturnSale data from SQL Server and transfers it to Kafka.
...
dag_config= DAGConfig(
    dag_id = 'table_dwh_rtl_dim_sale_is_return_sale_sync',
    description = 'Sync RTL.DIM_SaleIsReturnSale dimension table from SQL Server to Kafka',
...
table_config = TableConfiguration (
    table_name = 'RTL.DIM_SaleIsReturnSale',
    date_column = None,
...
kafka_topic_config= KafkaTopicConfig(
    name = 'dwh.table.curated.rtl.dim_saleisreturnsale',
    num_partitions = 3,
