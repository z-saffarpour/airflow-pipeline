"""
Airflow DAG: RTL.DIM_SalesType to Kafka (Config-based)
=================================================
This DAG reads dimension SalesType data from SQL Server and transfers it to Kafka.
...
dag_config= DAGConfig(
    dag_id = 'table_dwh_rtl_dim_sales_type_sync',
    description = 'Sync RTL.DIM_SalesType dimension table from SQL Server to Kafka',
...
kafka_topic_config= KafkaTopicConfig(
    name = 'dwh.table.curated.rtl.dim_salestype',
    num_partitions = 3,
